...
var b = class extends HTMLElement {
  ...
  requestUpdate(t3, s3, i5) {
    if (void 0 !== t3) {
      if (i5 ?? (i5 = this.constructor.getPropertyOptions(t3)), !(i5.hasChanged ?? f)(this[t3], s3))
        return;
      this.P(t3, s3, i5);
    }
  ...
  P(t3, s3, i5) {
    this._$AL.has(t3) || this._$AL.set(t3, s3), true === i5.reflect && this._$Em !== t3 && (this._$Ej ?? (this._$Ej = /* @__PURE__ */ new Set())).add(t3);
  }
  async _$ET() {
...
function S2(t3, i5, s3 = t3, e4) {
  ...
  return h3?.constructor !== o4 && (h3?._$AO?.(false), void 0 === o4 ? h3 = void 0 : (h3 = new o4(t3), h3._$AT(t3, s3, e4)), void 0 !== e4 ? (s3._$Co ?? (s3._$Co = []))[e4] = h3 : s3._$Cl = h3), void 0 !== h3 && (i5 = S2(t3, h3._$AS(t3, i5.values), h3, e4)), i5;
}
var M = class {
  constructor(t3, i5) {
  ...
  _$AI(t3, i5 = this, s3, e4) {
    ...
    if (void 0 === h3)
      ...
      for (t3 = h3[0], n4 = 0; n4 < h3.length - 1; n4++)
        r5 = S2(this, e5[s3 + n4], i5, n4), r5 === T && (r5 = this._$AH[n4]), o4 || (o4 = !c3(r5) || r5 !== this._$AH[n4]), r5 === E ? t3 = E : t3 !== E && (t3 += (r5 ?? "") + h3[n4 + 1]), this._$AH[n4] = r5;
    }
    o4 && !e4 && this.j(t3);
  }
  j(t3) {
...
// env-lit-css:/Users/konnor/projects/esbuild-plugin-lit-css-reproduction/src/components/callout/callout.css
var styles = i`:host {
  display: block;
}
div {
...
`;
var callout_default = styles;

// src/components/callout/callout.ts
var Callout = class extends r4 {
  render() {
    return x`<div></div>`;
  }
};
Callout.styles = [callout_default];
